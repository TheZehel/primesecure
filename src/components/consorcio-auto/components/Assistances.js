...
const Assistance = () => {
  const benefitsData = [
    {
      icon: faCar,
      title: "Troque seu veiculo",
      description: "Troque seu veículo com economia e sem juros. Simule agora!",
    ...
    },
    {
      ...
      description:
        "Adquira seu primeiro veículo com economia e sem juros. Simule agora!",
