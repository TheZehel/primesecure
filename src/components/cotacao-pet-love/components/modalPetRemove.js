export default function ModalRemoverPet({ pets, index, onRemovePet, cancelRemovePet }) {
  if (index === null) {
        ...
        <div className="m-auto relative w-full max-w-sm max-h-full">
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div className="p-6 text-center">
                  ...
                  <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Você deseja remover <span className="font-medium">{petName}</span>?</h3>
                  <button onClick={confirmModal} type="button" className="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-5">
                    Remover
                  </button>
