...
function InvoicePayment() {
    ...
    const retryPayment = () => {
        ...
        try {
            axios.post(`${apiUrl}/petlove/checkout/try-subscription-charge`, { subscription_id: 'sub_' + subscriptionId })
                .then((response)=>{
    ...
    useEffect(()=>{
        try {
            ...
            axios.post( `${apiUrl}/petlove/checkout/update-subscription-charge`, { encrypted } )
                .then((response)=>{
                    let data = response.data;
    ...
    useEffect(()=>{
        ...
        axios.get(`${apiUrl}/petlove/process/get-invoice-data/${subscriptionId}`)
            .then((response) => {
                var { data } = response;
