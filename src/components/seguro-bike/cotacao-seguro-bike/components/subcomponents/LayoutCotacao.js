...
const LayoutCotacaoPlanos = ({ title, position, userData, couponData }) => {
  ...
  return (
    <div
      className={`relative text-md w-full h-full max-w-screen-lg mx-auto mt-5 ${ animateOnce ? "animate__animated animate__fadeIn" : "" }`}
    > 
      <div className="w-fit h-fit mx-auto mb-6 realtive md:absolute md:mt-[12px] top-0 bottom-0 left-[15px]">
