...
export default class ProgressManager {
    ...
    async updateDegubLogData(data, step, error) {
        ...
        let url = `${apiUrl}/kakau-bike/log-history/update`;
    ...
    async navigateTo(step, path, navigate) {
        ...
        await axios.post(`${apiUrl}/kakau-bike/log-history/last-step`, { logToken: debugToken, step, error: false } )
            .then((response)=>{
                console.log("Usuário atualizado com sucesso", response.data);
    ...
    async getFormProgress(token) {
        ...
        let url = `${apiUrl}/kakau-bike/process/get-form-progress`;
        let progress = null;
