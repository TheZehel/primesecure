...
const PrimeIdeal = () => {
    ...
    const assistances = [
        ...
        },
        {
            ...
            icon: <Brain className="w-6 h-6 text-bluePrime" />
        },
    ];
    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="max-w-6xl mx-auto px-4 pt-20 pb-24">
                <h1 className="text-5xl mb-8 text-bluePrime font-semibold">Prime Ideal</h1>
                ...
                {activeTab === 'assistances' && (
                    <div className="grid md:grid-cols-2 gap-4">
                        {assistances.map((assistance) => (
                            <div key={assistance.id} className="border border-gray-300 rounded-md p-4">
                                <div className="flex space-x-3 text-center items-center justify-center pb-5">
                                    {assistance.icon}
                                    <h3 className="text-lg font-medium ">{assistance.title}</h3>
                                </div>
                                <p className="text-grayPrime mt-2">{assistance.description}</p>
                            </div>
                        ))}
                    </div>
                )}
