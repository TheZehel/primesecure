  ...
  const coverages = [
    {
      ...
      icon: (
        <Skull className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 text-bluePrime mb-2 mx-auto" />
      ),
    },
    {
      id: 2,
      ...
      description:
        'Garante o pagamento do capital segurado, de uma única vez, aos beneficiários em caso de morte do segurado por causas naturais ou acidentais.',
      icon: (
        <AlertCircle className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 text-bluePrime mb-2 mx-auto" />
      ),
    },
    {
      id: 3,
      ...
      icon: (
        <Activity className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 text-bluePrime mb-2 mx-auto" />
      ),
    },
    {
      id: 4,
    ...
    },
    {
      ...
      description:
        'Garante o pagamento de indenização complementar ao segurado em caso de lesão de determinados órgãos que determine a caracterização de invalidez permanente em virtude de acidente pessoal coberto.',
      icon: (
        <Heart className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 text-bluePrime mb-2 mx-auto" />
      ),
    },
    {
      id: 6,
      ...
      description:
        'Garante o pagamento do capital segurado contratado ao segurado no caso de diagnóstico definitivo de uma doença grave coberta ou da realização de um procedimento médico coberto.',
      icon: (
        <Pill className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 text-bluePrime mb-2 mx-auto" />
      ),
    },
    {
      id: 7,
      ...
      description:
        'Garante ao responsável pelo pagamento o reembolso das despesas incorridas com o funeral do segurado no caso de sua morte, até o limite do capital segurado contratado.',
      icon: (
        <Church className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 text-bluePrime mb-2 mx-auto" />
      ),
    },
    {
      id: 8,
    ...
    },
    {
      ...
      description:
        'Garante ao segurado o pagamento de uma diária segurada, para cada dia de internação hospitalar, por motivo de acidente pessoal ou doença.',
      icon: (
        <Hospital className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 text-bluePrime mb-2 mx-auto" />
      ),
    },
    {
      id: 10,
      title: 'Jazigo',
      description:
        'Garante ao responsável pelo pagamento o reembolso de despesas com aquisição de jazigo no caso de morte do segurado, por causas naturais ou acidentais.',
      icon: (
        <Church className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 text-bluePrime mb-2 mx-auto" />
      ),
    },
      ...
      <div className="bg-white shadow-xl rounded-lg p-6 max-w-lg w-full border-gray-200 border-2">
        ...
        <div className="text-center">
          ...
          <p className="text-bluePrime text-lg sm:text-xl mb-6">
            Não espere o imprevisto para agir. Com o Prime Vital, sua proteção é
            vitalícia.
          </p>
