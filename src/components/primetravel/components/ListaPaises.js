const ListaPaises = [
  ...
  { value: "Afeganistão", label: "Afeganistão", regiao: "4" },
  { value: "Arábia Saudita", label: "Arábia Saudita", regiao: "4" },
  { value: "Armênia", label: "Armênia", regiao: "4" },
  { value: "Azerbaijão", label: "Azerbaijão", regiao: "4" },
  { value: "Bahrein", label: "Bahrein", regiao: "4" },
  { value: "Bangladesh", label: "Bangladesh", regiao: "4" },
  { value: "Brunei", label: "Brunei", regiao: "4" },
  { value: "Butão", label: "Butão", regiao: "4" },
  { value: "Camboja", label: "Camboja", regiao: "4" },
  { value: "Cazaquistão", label: "Cazaquistão", regiao: "4" },
  { value: "China", label: "China", regiao: "4" },
  { value: "Coreia do Norte", label: "Coreia do Norte", regiao: "4" },
  { value: "Coreia do Sul", label: "Coreia do Sul", regiao: "4" },
  {
    value: "Emirados Árabes Unidos",
    label: "Emirados Árabes Unidos",
    regiao: "4",
  },
  { value: "Filipinas", label: "Filipinas", regiao: "4" },
  { value: "Geórgia", label: "Geórgia", regiao: "4" },
  { value: "Índia", label: "Índia", regiao: "4" },
  { value: "Indonésia", label: "Indonésia", regiao: "4" },
  { value: "Irã", label: "Irã", regiao: "4" },
  { value: "Iraque", label: "Iraque", regiao: "4" },
  { value: "Israel", label: "Israel", regiao: "4" },
  { value: "Japão", label: "Japão", regiao: "4" },
  { value: "Jordânia", label: "Jordânia", regiao: "4" },
  { value: "Kuwait", label: "Kuwait", regiao: "4" },
  { value: "Laos", label: "Laos", regiao: "4" },
  { value: "Líbano", label: "Líbano", regiao: "4" },
  { value: "Malásia", label: "Malásia", regiao: "4" },
  { value: "Maldivas", label: "Maldivas", regiao: "4" },
  { value: "Mianmar", label: "Mianmar", regiao: "4" },
  { value: "Mongólia", label: "Mongólia", regiao: "4" },
  { value: "Nepal", label: "Nepal", regiao: "4" },
  { value: "Omã", label: "Omã", regiao: "4" },
  { value: "Paquistão", label: "Paquistão", regiao: "4" },
  { value: "Qatar", label: "Qatar", regiao: "4" },
  { value: "Quirguistão", label: "Quirguistão", regiao: "4" },
  { value: "Rússia", label: "Rússia", regiao: "4" },
  { value: "Singapura", label: "Singapura", regiao: "4" },
  { value: "Síria", label: "Síria", regiao: "4" },
  { value: "Sri Lanka", label: "Sri Lanka", regiao: "4" },
  { value: "Tadjiquistão", label: "Tadjiquistão", regiao: "4" },
  { value: "Tailândia", label: "Tailândia", regiao: "4" },
  { value: "Taiwan", label: "Taiwan", regiao: "4" },
  { value: "Timor-Leste", label: "Timor-Leste", regiao: "4" },
  { value: "Turcomenistão", label: "Turcomenistão", regiao: "4" },
  { value: "Turquia", label: "Turquia", regiao: "4" },
  { value: "Uzbequistão", label: "Uzbequistão", regiao: "4" },
  { value: "Vietnã", label: "Vietnã", regiao: "4" },
  { value: "Iêmen", label: "Iêmen", regiao: "4" },
  { value: "Turcomenistão", label: "Turcomenistão", regiao: "4" },
  { value: "Uzbequistão", label: "Uzbequistão", regiao: "4" },
  { value: "Vietnã", label: "Vietnã", regiao: "4" },
  { value: "Iêmen", label: "Iêmen", regiao: "4" },
