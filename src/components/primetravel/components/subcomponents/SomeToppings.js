  ...
  return (
    ...
    >
      <div className="container mx-auto mb-10">
        <h2 className="text-center text-primary font-semibold mb-13 text-2xl sm:text-2xl my-5">
        ...
        <div className="grid justify-center md:grid-cols-2 gap-8 px-10 mt-20">
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="text-left">
              ...
              <p className="text-base mx-2 text-justify">
        ...
        <div className="grid md:grid-cols-2 gap-8 px-10">
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="text-left">
              ...
              <p className="text-base text-justify mx-2 ">
      ...
      <div className="flex justify-center flex-col">
        <div className="flex flex-col items-start text-left px-10 md:items-center md:text-center md:px-0">
          ...
          <div>
            <h3 className="text-xl font-bold mb-5 text-bluePrime mx-2">Sala VIP</h3>
            <p className="text-base text-justify md:text-center">
