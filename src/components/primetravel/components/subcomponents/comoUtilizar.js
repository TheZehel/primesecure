      ...
      <div className="container mx-auto px-4">
        <div className="row">
          <div className="titulo text-center mb-6">
            <h2 className="text-2xl font-bold text-grayPrime mt-20 mb-16">Saiba como utilizar</h2>
          </div>
        </div>
        <div className="row grid grid-cols-1 md:grid-cols-[1fr_auto_1fr_auto_1fr_auto_1fr] gap-4 items-center justify-center">
          <div className="flex flex-col justify-center items-center w-full md:w-64 h-52 shadow-lg rounded-lg border-bluePrime border-2">
            <h1 className="text-6xl text-bluePrime pb-4">1</h1>
            <p className="text-center text-grayPrime text-base">
          ...
          <div className="flex flex-col justify-center items-center w-full md:w-64 h-52 shadow-lg rounded-lg border-bluePrime border-2">
            <h1 className="text-6xl text-bluePrime pb-4">2</h1>
            <p className="text-center text-grayPrime text-base">
          ...
          <div className="flex flex-col justify-center items-center w-full md:w-64 h-52 shadow-lg rounded-lg border-bluePrime border-2">
            <h1 className="text-6xl text-bluePrime pb-4">3</h1>
            <p className="text-center text-grayPrime text-base">
          ...
          <div className="flex flex-col justify-center items-center w-full md:w-64 h-52 shadow-lg rounded-lg border-bluePrime border-2">
            <h1 className="text-6xl text-bluePrime pb-4">4</h1>
            <p className="text-center text-grayPrime text-base">
