...
const Payment = () => {
  ...
  useEffect(() => {
    const buildPaymentJSON = () => {
      ...
      const responsiblePassenger =
        JSON.parse(sessionStorage.getItem('responsiblePassenger')) || {};
      ...
      const paymentJSON = {
        ...
        TipoTelefoneEmergencia:
          responsiblePassenger.TipoTelefoneEmergencia || '',
          ...
          parameterlist: [
            {
              ...
              parametervalue: passenger.birthday || '1999-01-01',
            },
            {
              parametername: 'NomeViajante',
              parametervalue: passenger.firstName || `NomeV${index + 1}`,
            },
            {
              parametername: 'SobrenomeViajante',
              parametervalue: passenger.secondName || `SobrenomeV${index + 1}`,
            },
            {
              parametername: 'NomeSocialViajante',
              parametervalue: passenger.NomeSocial || `NomeSocialV${index + 1}`,
            },
            {
              parametername: 'SexoViajante',
              parametervalue: passenger.gender || 'M',
            },
            {
              parametername: 'CPFViajante',
              parametervalue: passenger.CPF || '778.261.566-61',
            },
    ...
    //Armazena o JSON de pagamento na sessionStorage
